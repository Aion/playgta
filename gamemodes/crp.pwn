...
//===============================[MAIN SETTINGS]================================================
#define GAMEMODE	"Pl@y.GTA v0.1" // This is what the gamemode text will be set to.
#define GAMEMODE_USE_VERSION	"No" // This shows the Server name and the version in Gamemode text, if set to "No" it will only display the gamemode name.
#define MAP_NAME	"Los Santos" // This is what the map name will be set to.
#define SERVER_NAME	"Pl@y.GTA - Roleplay" // This is what the hostname/servername will be set to.
#define WEBSITE	"play-at.net" // This is what the website will be set to.
...
#define PASSWORD	"playnetonly" // Server Password
